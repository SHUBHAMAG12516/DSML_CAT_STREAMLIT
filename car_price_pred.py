...
with col2:
    fuel_type_inp= st.selectbox(
        'Select the fuel type you would like to',
        ('Diesel', 'Petrol', 'CNG', 'LPG', 'Electric'))
col1, col2 = st.columns(2)

with col1:
    transmission_type_inp = st.selectbox(
        'Select the Transmission Type you would like',
        ('Manual', 'Automatic'))


with col2:
    engine = st.slider('Engine CC', 500, 10000, 100)
...
if st.button('Predict'):
    ...
    transmission_encoded= encode_dict['transmission_type'][transmission_type_inp]
